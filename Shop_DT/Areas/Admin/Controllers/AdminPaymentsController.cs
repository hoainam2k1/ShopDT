...
namespace Shop_DT.Areas.Admin.Controllers
{
    ...
    public class AdminPaymentsController : Controller
    {
        ...
        public AdminPaymentsController(db_Shop_DTContext context, INotyfService notifyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("PaymentId,PaymentName,PaymentDes,Active")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentId,PaymentName,PaymentDes,Active")] Payment payment)
        {
