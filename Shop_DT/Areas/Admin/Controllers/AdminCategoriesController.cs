...
namespace Shop_DT.Areas.Admin.Controllers
{
    ...
    public class AdminCategoriesController : Controller
    {
        ...
        public AdminCategoriesController(db_Shop_DTContext context, INotyfService notifyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            lsTrangThai.Add(new SelectListItem() { Text = "Hiển thị", Value = "1" });
            lsTrangThai.Add(new SelectListItem() { Text = "Không hiển thị", Value = "2" });
        ...
        public async Task<IActionResult> Create([Bind("CatId,CatName,Description,Published,Thumb,Title,Alias")] Category category, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CatId,CatName,Description,Published,Thumb,Title,Alias")] Category category, Microsoft.AspNetCore.Http.IFormFile fThumb)
        {
